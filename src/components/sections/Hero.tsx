      ...
      <div className={`container ${styles.heroGrid}`}>
        <div className={styles.heroCopy}>
          <div className={styles.topline}>
            <span className={styles.eyebrow}>Currículo para vaga de Web Designer</span>
            <span className={styles.roleTag}>HTML · CSS · React · Landing Pages</span>
          </div>
          <h1 className={styles.title}>Leonardo Teodoro Laureano</h1>

          <p className={styles.subtitle}>
            Profissional em transição para Web Design, com formação técnica em Engenharia da Computação
            até o 7º período, curso trancado no momento, e experiência anterior em suporte, comércio,
            atendimento, operação e rotina administrativa.
          </p>
          <p className={styles.summary}>
            Busco oportunidade para aplicar organização visual, clareza de comunicação e construção de páginas
            que apresentem bem produtos, serviços e informações. Tenho noção básica em inglês, facilidade para
            aprender novas tarefas e perfil colaborativo.
          </p>
          ...
          <div className={styles.contactStrip}>
            ...
            <span className={styles.contactItem}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" aria-hidden="true"><path d="M3 11.5 12 4l9 7.5"/><path d="M5 10v10h14V10"/></svg>
              Rua 14, Jardim Goiás, CEP 74810-180
            </span>
          </div>

          <div className={styles.identityRow}>
            <span className={styles.identityPill}>Brasileiro, solteiro, 33 anos</span>
            <span className={styles.identityPill}>Engenharia da Computação: 7º período, curso trancado</span>
            <span className={styles.identityPill}>Disponível para manhã, tarde e noite</span>
          </div>
        ...
        <aside className={styles.sidePanel}>
          ...
          <div className={styles.summaryCard}>
            ...
            <dl className={styles.summaryList}>
              ...
              <div>
                <dt>Base técnica</dt>
                <dd>Word, PowerPoint, Excel, Programação em C++ e manutenção de computadores.</dd>
              </div>
              <div>
                <dt>Idioma</dt>
              ...
              <div>
                <dt>Perfil</dt>
                <dd>Bom comunicador, iniciativa, trabalho em grupo e rápida aprendizagem.</dd>
              </div>
            </dl>
          </div>
        </aside>
