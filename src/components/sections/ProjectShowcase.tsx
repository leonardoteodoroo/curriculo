...
const PROJECTS_DATA: Project[] = [
  ...
  },
  {
    ...
    description:
      "Versão web do currículo com estrutura editorial, leitura escaneável e foco em apresentar perfil, trajetória e projetos.",
    placeholderLabel: "Preview em atualização",
      ...
      <div className="container">
        <header className={styles.header}>
          ...
          <p className={styles.sectionDesc}>
            Selecionei alguns trabalhos para reforçar o direcionamento em web
            design. As áreas de preview abaixo estão como placeholder para você
            trocar pelas imagens finais depois.
          </p>
        </header>
